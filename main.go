...
func Print_Input(verts [2][2][2]Vec, depth int, format string) {
	...
	front_face := map[string]string{"top": fmt.Sprintf("%s%s", verts[0][0][0].To_Ansi("000"), verts[0][0][1].To_Ansi("001")), "bottom": fmt.Sprintf("%s%s", verts[0][1][0].To_Ansi("010"), verts[0][1][1].To_Ansi("011"))}
	back_face := map[string]string{"top": fmt.Sprintf("%s%s", verts[1][0][0].To_Ansi("100"), verts[1][0][1].To_Ansi("101")), "bottom": fmt.Sprintf("%s%s", verts[1][1][0].To_Ansi("110"), verts[1][1][1].To_Ansi("111"))}
